<script lang="ts">
    ...
    import { supabase } from "$lib/supabaseInit"; // Used to fetch existing contract types
    ...
    $effect(() => {
        ...
        // Clear out termination details if status is not 'Terminated'
        ...
        // Sync the type based on whether the user is inputting a custom one or selecting an existing one
    ...
    function toggleCustomType() {
        ...
        if (!isCustomType) customContractType = ""; // Reset input 
    }
</script>
